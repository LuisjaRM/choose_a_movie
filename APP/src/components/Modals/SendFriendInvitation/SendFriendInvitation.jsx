import "./SendFriendInvitation.css";
...
// Service
import { sendFriendReqeuestService } from "../../../services/friendServices/sendFriendReqeuestService";

export const SendFriendInvitation = ({
  setShowUserMenu,
  setShowSendFriendInvitation,
}) => {
  // Const
  ...
  const handleClickExit = () => {
    setShowSendFriendInvitation(false);
  };
  ...
  const handleForm = async (e) => {
    ...
    try {
      await sendFriendReqeuestService(token, { username, email });
