...
// Service
import { patchPasswordService } from "../../../services/userServices/patchPasswordService";

export const SetPasswordModal = ({ setShowPatchPassword }) => {
  // Const
  ...
  const patchPassword = async () => {
    try {
      await patchPasswordService(token, {
        oldPassword,
        newPassword,
      });
  ...
  response && patchPassword() && setResponse(false);
