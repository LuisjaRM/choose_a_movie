...
const acceptRequestRoomQuery = async (id, room, username) => {
  let connection;
  try {
    ...
    if (room_users.length > 0) {
      ...
      const message = `${host_username} ha aceptado su solicitud para unirse a la sala ${room}.`;
...
module.exports = { acceptRequestRoomQuery };
