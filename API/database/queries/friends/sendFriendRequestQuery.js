...
const sendFriendRequestQuery = async (id, username, email) => {
  let connection;
  try {
    ...
    if (username != "") {
      ...
      const guest_id = guest_user[0].id;
      ...
      if (guest_user.length === 0) {
        ...
        if (host_username === username) {
          ...
          const message = `${host_username} te ha enviado una invitación para ser su amigo.`;
    ...
    if (email != "") {
      ...
      const host_email = host_user[0].email;
      ...
      if (host_email === email) {
        ...
        const mailBody = `
              ...
              ${process.env.PUBLIC_HOST}invitacion/${parameter}/${regCode}
        ...
        const htmlBody = `
              <section>
                ...
                <p>${process.env.PUBLIC_HOST}invitacion/${parameter}/${regCode}</p>
...
module.exports = { sendFriendRequestQuery };
